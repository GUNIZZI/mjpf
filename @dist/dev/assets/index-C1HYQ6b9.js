...
reactIs_production_min.isValidElementType=function(a){return "string"===typeof a||"function"===typeof a||a===e||a===m$1||a===g||a===f||a===p$1||a===q||"object"===typeof a&&null!==a&&(a.$$typeof===t||a.$$typeof===r||a.$$typeof===h||a.$$typeof===k||a.$$typeof===n||a.$$typeof===w||a.$$typeof===x||a.$$typeof===y||a.$$typeof===v$1)};reactIs_production_min.typeOf=z$1;
...
const animatePageIn = () => {
    ...
    if (transitionElement) {
        gsapWithCSS.fromTo(transitionElement, {
            y: '5rem',
            opacity: 0,
        }, {
            y: 0,
...
const animatePageOut = (href, navigate) => {
    const transitionElement = document.getElementById('transition-element');
    if (transitionElement) {
...
const Template = ({ children }) => {
    ...
    return jsx("div", { id: "transition-element", children: children });
};
...
const About = () => {
    const bedgeRefs = reactExports.useRef([]);
    const [selectIdx, setSelectIdx] = reactExports.useState(0);
    reactExports.useEffect(() => {
        bedgeRefs.current.forEach((bedge, index) => {
            if (index === selectIdx) {
                gsapWithCSS.to(bedge, {
                    opacity: 1,
                    scale: 1,
                    delay: 0.4,
                    duration: 0.6,
    ...
    return (jsx(Template, { children: jsx("div", { className: "isMaxWid", css: Style$1, children: jsx("div", { className: "wrap", children: jsx("div", { className: "selectors", children: jsx("ul", { children: menuItems.map((item, index) => (jsxs("li", { className: `${item.name} ${selectIdx === item.idx ? 'isSelect' : ''}`, children: [jsx("button", { type: "button", className: "selector", onClick: () => setSelectIdx(item.idx), children: item.name }), jsx("span", { className: "bedge", ref: el => {
                                        bedgeRefs.current[index] = el;
                                    }, children: item.value }), index === 0 && (jsx("div", { className: "detail", children: jsxs("button", { type: "button", children: [jsx("span", { children: "Detail" }), jsx("svg", { xmlns: "http://www.w3.org/2000/svg", width: "30", height: "30", viewBox: "0 0 30 30", fill: "none", children: jsx("path", { d: "M15 0L12.3563 2.64375L22.8188 13.125H0V16.875H22.8188L12.3563 27.3563L15 30L30 15L15 0Z", fill: "#292376" }) })] }) }))] }, item.idx))) }) }) }) }) }));
};

const Contact = () => {
    return (jsx(Template, { children: jsx("div", { children: jsx("strong", { children: "Contact" }) }) }));
};

const Portfolio = () => {
    return (jsx(Template, { children: jsx("div", { children: jsx("strong", { children: "Portfolio" }) }) }));
};
...
const Default = () => {
    ...
    return (jsxs("div", { css: Style, className: "isMaxWid", children: [jsx("header", { children: jsxs("div", { className: "wrap", children: [jsx("h1", { children: "MJ.Careers" }), jsx("nav", { children: jsxs("ul", { children: [jsx("li", { children: jsx(NavLink, { to: "/about", onClick: handleClick('/about'), children: "About me" }) }), jsx("li", { children: jsx(NavLink, { to: "/pf", onClick: handleClick('/pf'), children: "Portfolio" }) }), jsx("li", { children: jsx(NavLink, { to: "/contact", onClick: handleClick('/contact'), children: "Contact" }) })] }) })] }) }), jsx("main", { children: currentOutlet })] }));
};
...
`;
const GlobalStyles = () => jsx(Global, { styles: globalStyles });

// const router = createBrowserRouter(AppRoutes, { basename: '/guni' });
const router = createBrowserRouter(AppRoutes);
const queryClient = new QueryClient();
const AppProvider = () => {
    return (jsxs(QueryClientProvider, { client: queryClient, children: [jsx(GlobalStyles, {}), jsx(RouterProvider, { router: router })] }));
};

client.createRoot(document.getElementById("root")).render(/* @__PURE__ */ jsx(AppProvider, {}));
//# sourceMappingURL=index-C1HYQ6b9.js.map
